...
var $author$project$Main$SetBooksUrl = function (a) {
	return {$: 'SetBooksUrl', a: a};
};
...
var $author$project$Main$defaultModel = {books: _List_Nil};
...
var $author$project$Main$setBooksUrl = _Platform_incomingPort('setBooksUrl', $elm$json$Json$Decode$value);
...
var $author$project$Main$SetBookList = function (a) {
	return {$: 'SetBookList', a: a};
};
var $author$project$Main$Book = function (title) {
	return function (simpleTitle) {
						...
						return function (authors) {
							return function (lists) {
								return function (imageUrl) {
									return function (yearPublished) {
										return function (summary) {
											return function (rating) {
												return function (pages) {
													return function (dateRead) {
														return {authors: authors, basename: basename, dateRead: dateRead, id: id, imageUrl: imageUrl, link: link, lists: lists, pages: pages, publisher: publisher, rating: rating, simpleTitle: simpleTitle, summary: summary, title: title, yearPublished: yearPublished};
													};
												};
											};
										};
...
var $author$project$Main$Forthcoming = {$: 'Forthcoming'};
...
var $author$project$Main$decodeBook = function () {
	var mkBook = function (ti) {
		return function (si) {
			return function (bn) {
				return function (id) {
					return function (li) {
														...
														return function (mdt) {
															if (mdt.$ === 'Nothing') {
																return $elm$json$Json$Decode$succeed(
																	$author$project$Main$Book(ti)(si)(bn)(id)(li)(pu)(au)(ll)(iu)(yp)(su)(ra)(pa)($elm$core$Maybe$Nothing));
															} else {
																var dt = mdt.a;
																var _v1 = $justinmimbs$date$Date$fromIsoString(dt);
																if (_v1.$ === 'Err') {
																	var e = _v1.a;
																	return $elm$json$Json$Decode$fail('Error decoding: ' + (e + dt));
																} else {
																	var d = _v1.a;
																	return $elm$json$Json$Decode$succeed(
																		$author$project$Main$Book(ti)(si)(bn)(id)(li)(pu)(au)(ll)(iu)(yp)(su)(ra)(pa)(
				...
				A4(
					...
					A4(
						...
						A4(
							$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
							'yearPublished',
							A2($elm$json$Json$Decode$map, $author$project$Main$Year, $elm$json$Json$Decode$int),
							$author$project$Main$Forthcoming,
							A4(
								$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
								'imageUrl',
								$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string),
													...
													A3(
														...
														A3(
															...
															A3(
																...
																'title',
																$elm$json$Json$Decode$string,
																$elm$json$Json$Decode$succeed(mkBook))))))))))))))));
}();
...
var $author$project$Main$decodeBookList = $elm$json$Json$Decode$dict($author$project$Main$decodeBook);
...
var $author$project$Main$loadBooks = function (url) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$SetBookList, $author$project$Main$decodeBookList),
			url: url
		});
};
		...
		switch (msg.$) {
			...
			case 'SetBooksUrl':
				...
				return _Utils_Tuple2(
					model,
					$author$project$Main$loadBooks(url));
			default:
				var r = msg.a;
				var byDate = F2(
					function (a, b) {
						var b0 = A2(
							$elm$core$Maybe$withDefault,
							A2($justinmimbs$date$Date$fromOrdinalDate, 0, 1),
							b.dateRead);
						var a0 = A2(
							$elm$core$Maybe$withDefault,
							A2($justinmimbs$date$Date$fromOrdinalDate, 0, 1),
							a.dateRead);
						return A2($justinmimbs$date$Date$compare, b0, a0);
					});
				var bookDict = A2(
					$elm$core$Maybe$withDefault,
					$elm$core$Dict$empty,
					$elm$core$Result$toMaybe(
						A2($elm$core$Debug$log, 'Doom', r)));
				var books = A2(
					$elm$core$List$map,
					$elm$core$Tuple$second,
					$elm$core$Dict$toList(bookDict));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							books: A2($elm$core$List$sortWith, byDate, books)
						}),
...
var $author$project$Main$showYear = function (yp) {
	if (yp.$ === 'Year') {
		var y = yp.a;
		return 'Published in ' + $elm$core$String$fromInt(y);
	} else {
		return 'Forthcoming';
	}
};
...
var $author$project$Main$renderBook = function (book) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('date-read')
					]),
				A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					A2(
						...
						function (d) {
							return _List_fromArray(
								[
									$elm$html$Html$text(
									A2($justinmimbs$date$Date$format, 'MMM y', d))
								]);
						},
						book.dateRead))),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('book-image')
					]),
				A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
						...
						function (i) {
							return _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('/books/' + (book.basename + '.html'))
										]),
									_List_fromArray(
										[
											A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('book-content')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('book-title')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(book.simpleTitle)
									])),
								A2(
								$elm$html$Html$small,
								_List_Nil,
								_Utils_ap(
									_List_fromArray(
										[
											$elm$html$Html$text(' | '),
											$elm$html$Html$text(
											$author$project$Main$showYear(book.yearPublished))
										]),
									A2(
										$elm$core$Maybe$withDefault,
										_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('book-authors')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('book-summary')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($elm$core$Maybe$withDefault, '', book.summary))
							]))
					]))
			]));
};
var $author$project$Main$renderBooks = function (books) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Main$renderBook, books));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$renderBooks(model.books)
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		subscriptions: function (_v1) {
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						$author$project$Main$setBooksUrl(
						A2(
